...
static const char *TAG = "disp-oled";
#define I2C_HOST  0
...
void app_display_run(void *pvArgs)
{
    while (1) {
...
void app_display_create_thread(void)
{
    xTaskCreatePinnedToCore(app_display_run, "display", 4096, NULL, 1, NULL, tskNO_AFFINITY);
}
